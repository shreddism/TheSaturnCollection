...
namespace Saturn 
{
    ...
    public class KalmanVector2
    {
        ...
        public Vector2 Update2(Vector2 measuredPosition, MultifilterCore filter)
        {
            float xState = (float)xFilter.Update2(measuredPosition.X, filter);
            float yState = (float)yFilter.Update2(measuredPosition.Y, filter);
            return new Vector2(xState, yState);
        }
    ...
    public class Matrix
    {
        ...
        public static Matrix MultiplyByTransposed(Matrix a, Matrix b) // When matrices are not 4x4
        {
            var result = new double[a.Rows, b.Rows];
                for (int i = 0; i < a.Rows; i++)
        ...
        public static Matrix Multiply(Matrix a, Matrix b, MultifilterCore filter) // Always scalar
        {
            var result = new double[a.Rows, b.Cols];
                for (int i = 0; i < a.Rows; i++)
                    for (int j = 0; j < b.Cols; j++)
